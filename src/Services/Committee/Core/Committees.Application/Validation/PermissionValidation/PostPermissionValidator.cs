namespace Committees.Application.Validation.PermissionValidation
{
    public class PostPermissionValidator : AbstractValidator<PostPermissionCommand>
    {
        public PostPermissionValidator()
        {
            RuleFor(x => x.NameAr)
